...
// Fungsi standar Suara AI (Suara Berat/Cowo)
function hitSuaraAI(teks) {
    if ('speechSynthesis' in window) {
        ...
        rasan.lang = 'id-ID';
        rasan.rate = 0.95; 
        rasan.pitch = 0.5; // Membuat suara robot bawaan lebih nge-bass/berat
...
// Pancingan Audio Browser agar 0.mp3 diizinkan berputar otomatis saat game jalan
...
// Fungsi khusus: AI Ngomong dulu -> Selesai -> Putar 0.mp3
    ...
    if ('speechSynthesis' in window) {
        ...
        rasan.onend = function() {
            try {
                ...
                console.log("Gagal memutar audio mp3:", e);
            }
        };
...
function prosesRondeBerikutnya() {
    ...
    if (adaJuara) {
        ...
        if (unikKorban.length > 0) {
            ...
            // REVISI TOTAL: "Ciee minus" dihapus mutlak diganti kalimat di bawah ini
            if (adaMinus) {
